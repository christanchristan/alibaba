...
class AddProductForm(forms.ModelForm):
    title = forms.CharField(
        widget=forms.TextInput(attrs={'placeholder': "Product Title", "class":"form-control"})
    )
    ...
    type = forms.CharField(
        widget=forms.TextInput(attrs={'placeholder': "Type of product e.g Habesha Dress", "class":"form-control"})
    )
    ...
    mfd = forms.DateTimeField(
        widget=forms.DateTimeInput(attrs={'placeholder': "e.g: 2001-11-11 00:00:00", "class":"form-control"})
    )
    ...
    class Meta:
        ...
        fields = [
            ...
            'digital',
            'category',
            'product_status',   # <-- added this
        ]
        widgets = {
            # you can override the widget if needed, e.g.:
