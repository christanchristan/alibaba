...
from delivery.decorators import delivery_required
...
def products(request): 
    ...
    return render(request, "delivery/products.html", context)
...
def change_product_status(request, pid):
    ...
    if request.method == "POST":
        ...
        if new_status in ["published", "draft", "disabled"]:
            ...
            product.save()
    return redirect("delivery:dashboard-products")
@delivery_required
def add_product(request):
    ...
    return render(request, "delivery/add-products.html", {"form": form})
...
def edit_product(request, pid):
    ...
    return render(request, "delivery/edit-products.html", context)
...
def orderss(request):
    ...
    return render(request, "delivery/orderss.html", context)
...
def delivery_dashboard(request):
    ...
    return render(request, "delivery/vendor_dashboard.html", context)
...
def ordersss(request):
    ...
    return render(request, "delivery/cont.html", context)
@delivery_required
...
def change_order_status(request, oid):
    ...
    return redirect("delivery:order_detail", order.id)
...
def shop_page(request):
    ...
    return render(request, "delivery/shop_page.html", context)
...
def change_password(request):
    ...
    if request.method == "POST":
        ...
        if confirm_new_password != new_password:
            ...
            return redirect("delivery:change_password")
